          ...
          <table style="border-color:blue; " border="0" cellspacing="0px" width="800" cellpadding="0px">
            <tbody>
                ...
                <td width="10%">
				  ...
				  <td width="40%">
					  ...
					  <div id="qrvalue" style="visibility: hidden;width:140px;height:140px;">
						  ...
						  "plaka":"<xsl:value-of select="n1:DespatchAdvice/cac:Shipment/cac:ShipmentStage/cac:TransportMeans/cac:RoadTransport/cbc:LicensePlateID[@schemeID='PLAKA']"/>"}
					  </div>
					  <script type="text/javascript">
              ...
              <tr valign="top">
                ...
                <td width="20%"/>
                <td width="60%" align="center" valign="bottom" colspan="4">
            ...
            <tbody>
              <tr class="lineTableTr">
                ...
                <td class="lineTableTd" style="width:20%" align="center">
                  <span style="font-weight:bold;">
                    <xsl:text>Diğer Bilgiler</xsl:text>
                  </span>
                </td>
          ...
          <tbody>
            ...
            <tr align="left">
            	<td style="padding:10px">
            		<xsl:for-each select="//n1:DespatchAdvice/cac:Note">
				          <xsl:value-of select="."/>
				          <br/>
				        </xsl:for-each>
            	</td>
