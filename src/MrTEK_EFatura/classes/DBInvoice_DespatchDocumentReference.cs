...
{
	public partial class Invoice_DespatchDocumentReference
	{
		...
		public bool Load()
		{
			...
			cmd.CommandText = "SELECT * FROM Invoice_DespatchDocumentReference WHERE nID = " + this.nID;
		...
		public bool Save()
		{
			...
			if (nID == 0)
			{
				cmd.CommandText = "INSERT INTO Invoice_DespatchDocumentReference (InvoiceID, ID, IssueDate) "; 
			...
			{
				cmd.CommandText = "UPDATE Invoice_DespatchDocumentReference SET InvoiceID=@InvoiceID, ID=@ID, IssueDate=@IssueDate ";
