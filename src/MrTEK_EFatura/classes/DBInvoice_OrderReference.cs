...
{
	public partial class Invoice_OrderReference
	{
		...
		public bool Load()
		{
			...
			cmd.CommandText = "SELECT * FROM Invoice_OrderReference WHERE nID = " + this.nID;
		...
		public bool Save()
		{
			...
			if (nID == 0)
			{
				cmd.CommandText = "INSERT INTO Invoice_OrderReference (InvoiceID, ID, IssueDate) "; 
			...
			{
				cmd.CommandText = "UPDATE Invoice_OrderReference SET InvoiceID=@InvoiceID, ID=@ID, IssueDate=@IssueDate ";
